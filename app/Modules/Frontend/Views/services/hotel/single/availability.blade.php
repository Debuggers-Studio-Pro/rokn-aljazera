        ...
        <div>
            @if ($booking_form == 'enquiry' || $booking_form == 'both')
                @if ($external_booking == 'on')
                    <a href="{{ esc_url($post['external_link']) }}"
                        class="btn btn-primary btn-book-now mt-0">{{ __('Book Now') }}</a>
                @endif
        ...
        @if ($external_booking != 'on')
            <div class="section-content">
                <div id="room-render-wrapper" class="room-render-wrapper">
                    ...
                    <form id="gmz-room-booking" action="{{ url('hotel-add-cart') }}" method="POST"
                        data-action-real-price="{{ url('room-get-real-price') }}">
                        ...
                        <div id="room-booking-form" class="room-booking-form">
                            ...
                            <div class="d-flex justify-content-between">
                                            ...
                                            @foreach ($extra_services as $ek => $ev)
                                                <div class="col-lg-6">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" class="gmz-checkbox-item"
                                                            name="extra_service[]" value="{{ $ek }}" />
                                ...
                                <div class="booking-form-detail @if (empty($extra_services)) alone @endif">
                                    ...
                                    {{-- <div class="mt-2">
                                        Do you also want to book Transportation ?
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="carSelect" name="car">
                                            <option value="" selected>Choose a Transportation</option>
                                            <option value="car1">Transportation 1 - price SER85</option>
                                            <option value="car2">Transportation 2 - price SER25</option>
                                            <option value="car3">Transportation 3 - price SER95</option>
                                            <option value="car4">Transportation 4 - price SER55</option>
                                        </select>
                                    </div>

                                    <div class="form-group">
                                        <div class="available-seats">Available seats: 14</div>
                                    </div>

                                    <div class="form-group">
                                        <label for="totalSeats">Total seats to book:</label>
